...
extern const uint8_t c_chBat816_Full[16];
extern const uint8_t c_chBat816_TwoThird[16];
extern const uint8_t c_chBat816_OneThird[16];
extern const uint8_t c_chBat816_Empty[16];
